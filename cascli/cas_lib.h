 ...
 */
int add_core(uint32_t cache_id, unsigned int core_id, const char *core_device, int try_add, int update_path);

int get_core_info(uint32_t cache_id, int core_id, struct kcas_core_info *info, bool by_id_path);
